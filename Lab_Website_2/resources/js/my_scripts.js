...
function loadStatsPage()
{
	...
	for(var i = 2; i < document.getElementById("stats_table").rows.length; i++){
		var home = document.getElementById("stats_table").rows[i].cells[2].innerHTML;
		console.log("Home = "+home);
		var away = document.getElementById("stats_table").rows[i].cells[3].innerHTML;
		...
		{
			winner = document.getElementById("stats_table").rows[i].cells[1].innerHTML;
			cuLosses++;
		}
...
function loadPlayersPage()
{
	...
	{
		var a = '<a href = "#" onclick="switchPlayers('+i+')">'+players[i].name+'</a><br>';
...
function switchPlayers(playerNum)
{
	...
	document.getElementById("p_year").alt = players[playerNum].alt;
